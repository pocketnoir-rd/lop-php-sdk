<?php
namespace Jd\WebSocket\Async\Swoole;
...
class WebSocketClient {
    ...
    public function connect($host, $port, $path, $timeout)
    {
        $this->host = $host;
        $this->port = $port;
        $this->path = $path;
    ...
    public function sendHandShake()
    {
        ...
        $request = $this->handler->buildHandShakeRequest($this->host, $this->port, $this->path);
